...
if ( ! function_exists( 'understrap_widgets_init' ) ) {
	...
	function understrap_widgets_init() {
		...
		register_sidebar(
			array(
				'name'          => __( 'Below Nav', 'understrap' ),
				'id'            => 'belownav',
				'description'   => __( 'Below nav widget with dynamic grid', 'understrap' ),
				'before_widget' => '<div class="navbar-nav">',
				'after_widget'  => '</div>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
			)
...
require_once 'widgets-extra-class.php';